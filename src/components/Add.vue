    ...
    <form action="" v-on:submit="addCustomer">
      ...
      <div class="well">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="" type="text" value="" placeholder="Address"/>
        </div>
        <div class="form-group">
          <label for="">City</label>
          <input class="form-control" name="" type="text" value="" placeholder="City"/>
        </div>
        <div class="form-group">
          <label for="">State</label>
          <input class="form-control" name="" type="text" value="" placeholder="State"/>
        </div>
      </div>
    </form>
  </div>
